...
const CACHE_NAME = `decomshop-app-cache-v${CACHE_VERSION}`;
const STATIC_CACHE_NAME = `decomshop-static-cache-v${CACHE_VERSION}`;
...
self.addEventListener("push", (event) => {
  ...
  event.waitUntil(
    self.registration.showNotification("디컴소프트 자동매매", options),
  );
});
