        ...
        >
          ...
          >
            ...
            <div style={{ 
              ...
              padding: '12px', 
              backgroundColor: theme === 'dark' 
                ? (apiMode === 'real' ? '#7f1d1d' : '#1e3a8a')
                : (apiMode === 'real' ? '#fef2f2' : '#eff6ff'), 
              borderRadius: '8px',
              ...
              <p style={{ 
                ...
                WebkitTextFillColor: 'transparent',
                backgroundClip: 'text',
                color: apiMode === 'real' ? '#991b1b' : '#1e40af'
              }}>
                💡 <strong>사용 방법:</strong><br />
                • <strong>라이선스 키:</strong> 관리자가 발급한 키를 입력하세요 (필수)<br />
                • <strong>App Key / Secret Key:</strong> 키움증권 OpenAPI에서 발급받은 키를 입력하세요 (필수)<br />
                {licenseKey.trim() && keyInfo && keyInfo.remainingDays !== undefined && keyInfo.remainingDays > 0 && (
                  <span style={{ 
                    backgroundImage: 'linear-gradient(135deg, #10b981 0%, #059669 100%)',
                    WebkitBackgroundClip: 'text',
                    WebkitTextFillColor: 'transparent',
                    backgroundClip: 'text',
                    fontWeight: 'bold'
                  }}><br />✓ 라이선스 키 유효 (남은 기간: {keyInfo.remainingDays}일)</span>
                )}
                <br /><br />
                <strong>키움증권 키 발급 방법 ({apiMode === 'real' ? '실전투자' : '모의투자'}):</strong><br />
                1. 키움증권 OpenAPI 사이트 접속<br />
                   &nbsp;&nbsp;&nbsp;실전: <a href="https://openapi.kiwoom.com" target="_blank" style={{ 
                     backgroundImage: theme === 'dark' 
                       ? 'linear-gradient(135deg, #fca5a5 0%, #ef4444 100%)'
                       : 'linear-gradient(135deg, #991b1b 0%, #dc2626 100%)',
                     WebkitBackgroundClip: 'text',
                     ...
                     backgroundClip: 'text',
                     color: apiMode === 'real' ? '#991b1b' : '#1e40af'
                   }}>https://openapi.kiwoom.com</a><br />
                   &nbsp;&nbsp;&nbsp;모의: <a href="https://openapi.kiwoom.com" target="_blank" style={{ 
                     backgroundImage: theme === 'dark' 
                       ? 'linear-gradient(135deg, #93c5fd 0%, #3b82f6 100%)'
                       : 'linear-gradient(135deg, #1e40af 0%, #3b82f6 100%)',
                     WebkitBackgroundClip: 'text',
                     ...
                     backgroundClip: 'text',
                     color: apiMode === 'real' ? '#991b1b' : '#1e40af'
                   }}>https://openapi.kiwoom.com</a> (모의투자 메뉴)<br />
                2. 로그인 후 "API 사용신청" 메뉴 선택<br />
                3. "App Key" 및 "Secret Key" 발급<br />
                4. 발급받은 키를 위 입력란에 입력<br />
                {apiMode === 'real' && (
                  <>
                    <br />
                    <span style={{ 
